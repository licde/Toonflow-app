...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    onMounted(async () => {
      const { MdEditor } = await __vitePreload(async () => { const { MdEditor } = await import('./markdown-S9HtUHKW.js').then(n => n.i);return { MdEditor }},true?__vite__mapDeps([0,1,2]):void 0,import.meta.url);
