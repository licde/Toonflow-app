const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./mdEditorSetup-Bddadd_b.js","./markdown-S9HtUHKW.js","./vue-vendor-Cj7sXJnb.js","./dayjs-CuToSpIM.js","./404-DZ9vO0SH.js","./tdesign-C157N6jJ.js","./i18n-DbW3ZkIb.js","./index-FQhXerfT.js","./axios-BzO0kuq-.js","./project-C_OB2JAu.js","./index-8L73heGh.js","./AsyncMdEditor-B6a7ynjr.js","./modelSelect-CP2wRMzT.js","./providersLogo-BCbaFq8_.js","./imageListCache-NuwaVChp.js","./index-CJToMvPl.js","./index-CAVgHCs_.js","./loadMammoth-Cd5aeDfC.js","./index-Blqvyc8N.js","./assetsCheck-C3hsdxZF.js","./index-7l_O1IwH.js","./index-CahgfoAb.js","./AsyncMdPreview-Wrs0kg5K.js","./splitpanes-CClU71rU.js","./tdesign-chat-DyzTIWAa.js","./productionAgent-I8pXhmTU.js","./index-Dx9qDQHN.js","./imageTools-BU0BDM0I.js","./index-CJbGyI4R.js","./vueflow-BeRgUeVC.js","./index-CSzHb-xL.js","./registerIconPark-BwPQysAk.js","./icons-DiutqkIw.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from './markdown-S9HtUHKW.js';
import { l as defineComponent, o as onMounted, b as onUnmounted, b2 as resolveComponent, aK as openBlock, aL as createElementBlock, aO as createBaseVNode, j as createVNode, r as ref, bD as defineStore, bL as useLocalStorage, bM as storeToRefs, w as watch, v as onBeforeMount, n as nextTick, a1 as unref, aS as createBlock, aT as createCommentVNode, aM as withCtx, F as Fragment, c as computed, bN as createRouter, bO as createWebHashHistory, bC as createApp, bP as createPinia, bQ as src_default } from './vue-vendor-Cj7sXJnb.js';
import { q as ConfigProvider, r as enUs, z as zhCn, L as Loading, M as MessagePlugin, s as LoadingPlugin, v as vLoading } from './tdesign-C157N6jJ.js';
import { c as createI18n } from './i18n-DbW3ZkIb.js';
...
const localeLoaders = {
  "zh-CN": () => __vitePreload(() => import('./zh-CN-DjwPfweN.js'),true?[]:void 0,import.meta.url),
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    async function getPort() {
      ...
      const { setupMdEditor } = await __vitePreload(async () => { const { setupMdEditor } = await import('./mdEditorSetup-Bddadd_b.js');return { setupMdEditor }},true?__vite__mapDeps([0,1,2,3]):void 0,import.meta.url);
  ...
  routes: [
    {
      ...
      component: () => __vitePreload(() => import('./404-DZ9vO0SH.js'),true?__vite__mapDeps([4,2,3,5,1,6]):void 0,import.meta.url)
    },
    {
      path: "/",
      redirect: "/workbench"
    ...
    {
      path: "/workbench",
      component: () => __vitePreload(() => import('./index-FQhXerfT.js').then(n => n.i),true?__vite__mapDeps([7,1,2,3,8,5,6,9]):void 0,import.meta.url),
      redirect: "/project",
      children: [
        {
          path: "/project",
          component: () => __vitePreload(() => import('./index-8L73heGh.js'),true?__vite__mapDeps([10,2,3,8,5,11,1,12,13,9,14,6]):void 0,import.meta.url)
        },
        {
          path: "/task",
          component: () => __vitePreload(() => import('./index-CJToMvPl.js'),true?__vite__mapDeps([15,3,8,2,5,9,1,6]):void 0,import.meta.url)
        },
        // {
        //   path: "/detail",
        ...
        {
          path: "/novel",
          component: () => __vitePreload(() => import('./index-CAVgHCs_.js'),true?__vite__mapDeps([16,2,3,8,5,17,1,9,6]):void 0,import.meta.url)
        },
        {
          path: "/script",
          component: () => __vitePreload(() => import('./index-Blqvyc8N.js'),true?__vite__mapDeps([18,2,3,8,5,19,20,12,13,9,1,6,17,14]):void 0,import.meta.url)
        },
        {
          path: "/scriptAgent",
          component: () => __vitePreload(() => import('./index-CahgfoAb.js'),true?__vite__mapDeps([21,2,3,11,1,5,22,23,8,24,9,25,6]):void 0,import.meta.url)
        },
        {
          path: "/cornerScape",
          component: () => __vitePreload(() => import('./index-Dx9qDQHN.js'),true?__vite__mapDeps([26,27,2,3,5,8,9,12,13,19,20,1,6]):void 0,import.meta.url)
        },
        {
          path: "/production",
          component: () => __vitePreload(() => import('./index-CJbGyI4R.js').then(n => n.i),true?__vite__mapDeps([28,1,2,3,29,8,5,9,25]):void 0,import.meta.url)
        },
        {
          path: "/assets",
          component: () => __vitePreload(() => import('./index-7l_O1IwH.js'),true?__vite__mapDeps([20,3,12,2,13,8,5,9,1,6]):void 0,import.meta.url)
        },
        ...[]
      ]
    },
    {
      path: "/login",
      component: () => __vitePreload(() => import('./index-CSzHb-xL.js'),true?__vite__mapDeps([30,6,2,3,8,5,1]):void 0,import.meta.url)
    }
  ]
});
...
async function bootstrap() {
  ...
  const { registerIconPark } = await __vitePreload(async () => { const { registerIconPark } = await import('./registerIconPark-BwPQysAk.js');return { registerIconPark }},true?__vite__mapDeps([31,32,2,3]):void 0,import.meta.url);
