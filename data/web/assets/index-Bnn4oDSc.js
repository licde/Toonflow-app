import { l as defineComponent, bM as storeToRefs, b_ as useMousePressed, b$ as useMouse, w as watch, K as watchEffect, o as onMounted, b2 as resolveComponent, a7 as resolveDirective, aK as openBlock, aL as createElementBlock, aO as createBaseVNode, j as createVNode, a1 as unref, a$ as createTextVNode, b0 as toDisplayString, bH as withModifiers, E as withDirectives, aM as withCtx, F as Fragment, aP as renderList, aS as createBlock, aU as normalizeClass, aT as createCommentVNode, av as isRef, aQ as normalizeStyle, r as ref } from './vue-vendor-Cj7sXJnb.js';
import { i as instance } from './axios-B2i2rFrf.js';
import { a as ChatMessage, C as ChatList, b as ChatSender } from './tdesign-chat-DyzTIWAa.js';
import { a as useProductionAgentStore } from './productionAgent-DofsG6cz.js';
import { p as projectStore } from './project-C_OB2JAu.js';
import { a5 as Popup, B as Button, W as DialogPlugin } from './tdesign-C157N6jJ.js';
