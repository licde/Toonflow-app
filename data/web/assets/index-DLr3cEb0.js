const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./uiConfig-DffG_VJ2.js","./index-DsDM6Bax.js","./markdown-S9HtUHKW.js","./vue-vendor-Cj7sXJnb.js","./dayjs-CuToSpIM.js","./tdesign-C157N6jJ.js","./i18n-DbW3ZkIb.js","./languageConfig-DwbnfMv_.js","./requestConfig-nl9-hXUy.js","./loginConfig-Ctnvs95v.js","./axios-B2i2rFrf.js","./agentConfog-DX32nBl1.js","./modelSelect-Bj3Bcvu6.js","./providersLogo-BCbaFq8_.js","./dbConfig-DCB0vPRo.js","./otherConfig-CL3Rndiy.js","./about-CdZPUjs_.js","./index-BDOs4WmZ.js","./project-C_OB2JAu.js","./logoutConfig-DjdSxe3v.js","./vendorConfig-bB4UMyqz.js","./AsyncMdPreview-BoZmGdmW.js","./AsyncMonacoEditor-O1xOzXHE.js","./memoryConfig-Cy0a1wcH.js","./fileManagement-YvP43-9Z.js","./skillManagement-DOzEUE9Q.js","./AsyncMdEditor-Cf72DQX2.js","./devConfig-L0uUQ3c-.js","./promptManage-Blak2dE3.js","./modelMap-DdVimser.js"])))=>i.map(i=>d[i]);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const uiConfig = defineAsyncComponent(() => __vitePreload(() => import('./uiConfig-DffG_VJ2.js'),true?__vite__mapDeps([0,1,2,3,4,5,6]):void 0,import.meta.url));
    const languageConfig = defineAsyncComponent(() => __vitePreload(() => import('./languageConfig-DwbnfMv_.js'),true?__vite__mapDeps([7,6,3,4,1,2,5]):void 0,import.meta.url));
    const requestConfig = defineAsyncComponent(() => __vitePreload(() => import('./requestConfig-nl9-hXUy.js'),true?__vite__mapDeps([8,1,2,3,4,5,6]):void 0,import.meta.url));
    const loginConfig = defineAsyncComponent(() => __vitePreload(() => import('./loginConfig-Ctnvs95v.js'),true?__vite__mapDeps([9,10,1,2,3,4,5,6]):void 0,import.meta.url));
    const agentConfog = defineAsyncComponent(() => __vitePreload(() => import('./agentConfog-DX32nBl1.js'),true?__vite__mapDeps([11,12,3,4,13,1,2,5,6,10]):void 0,import.meta.url));
    const dbConfig = defineAsyncComponent(() => __vitePreload(() => import('./dbConfig-DCB0vPRo.js'),true?__vite__mapDeps([14,10,1,2,3,4,5,6]):void 0,import.meta.url));
    const otherConfig = defineAsyncComponent(() => __vitePreload(() => import('./otherConfig-CL3Rndiy.js'),true?__vite__mapDeps([15,1,2,3,4,5,6]):void 0,import.meta.url));
    const about = defineAsyncComponent(() => __vitePreload(() => import('./about-CdZPUjs_.js'),true?__vite__mapDeps([16,17,2,3,4,10,1,5,6,18]):void 0,import.meta.url));
    const logoutConfig = defineAsyncComponent(() => __vitePreload(() => import('./logoutConfig-DjdSxe3v.js'),true?__vite__mapDeps([19,3,4,5,1,2,6]):void 0,import.meta.url));
    const vendorConfig = defineAsyncComponent(() => __vitePreload(() => import('./vendorConfig-bB4UMyqz.js'),true?__vite__mapDeps([20,3,4,21,2,5,1,6,22,10,13]):void 0,import.meta.url));
    const memoryConfig = defineAsyncComponent(() => __vitePreload(() => import('./memoryConfig-Cy0a1wcH.js'),true?__vite__mapDeps([23,10,1,2,3,4,5,6]):void 0,import.meta.url));
    const fileManagement = defineAsyncComponent(() => __vitePreload(() => import('./fileManagement-YvP43-9Z.js'),true?__vite__mapDeps([24,1,2,3,4,5,6,10]):void 0,import.meta.url));
    const skillManagement = defineAsyncComponent(() => __vitePreload(() => import('./skillManagement-DOzEUE9Q.js'),true?__vite__mapDeps([25,26,2,3,4,5,1,6,21,10]):void 0,import.meta.url));
    const devConfig = defineAsyncComponent(() => __vitePreload(() => import('./devConfig-L0uUQ3c-.js'),true?__vite__mapDeps([27,22,2,3,4,5,1,6,10]):void 0,import.meta.url));
    const promptManage = defineAsyncComponent(() => __vitePreload(() => import('./promptManage-Blak2dE3.js'),true?__vite__mapDeps([28,10,1,2,3,4,5,6,26]):void 0,import.meta.url));
    const modelMap = defineAsyncComponent(() => __vitePreload(() => import('./modelMap-DdVimser.js'),true?__vite__mapDeps([29,10,1,2,3,4,5,6,26]):void 0,import.meta.url));
    const menuItems = [
