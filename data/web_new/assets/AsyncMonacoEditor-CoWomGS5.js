const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./monaco-ClIclUAR.js","./markdown-CDQfeHxT.js","./vue-vendor-Byo5TD6r.js","./dayjs-CuToSpIM.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from './markdown-CDQfeHxT.js';
import { L as Loading } from './tdesign-CfL1pweZ.js';
import { l as defineComponent, o as onMounted, a1 as unref, aK as openBlock, aS as createBlock, bF as normalizeProps, m as mergeProps, a_ as resolveDynamicComponent, aL as createElementBlock, j as createVNode, aj as shallowRef } from './vue-vendor-Byo5TD6r.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    onMounted(async () => {
      const mod = await __vitePreload(() => import('./monaco-ClIclUAR.js'),true?__vite__mapDeps([0,1,2,3]):void 0,import.meta.url);
