import { l as defineComponent, bM as storeToRefs, bU as useModel, w as watch, aL as createElementBlock, j as createVNode, aM as withCtx, bV as mergeModels, aK as openBlock, aO as createBaseVNode, b0 as toDisplayString, a1 as unref, a$ as createTextVNode, F as Fragment, aP as renderList, aS as createBlock, r as ref, b2 as resolveComponent, av as isRef, bH as withModifiers, aT as createCommentVNode, c as computed, o as onMounted, b as onUnmounted } from './vue-vendor-Byo5TD6r.js';
import { i as instance } from './axios-CST2I6_d.js';
import { o as openAssetsSelector } from './assetsCheck-C_EAKhUb.js';
import { s as settingStore, _ as _export_sfc } from './index-CYEzD5Ot.js';
import { E as Dialog, H as Form, J as FormItem, R as Input, T as Textarea, B as Button, a2 as Title, X as Tag, a0 as Upload, s as LoadingPlugin, U as Tabs, V as TabPanel, D as Divider, Z as Table, n as Tooltip, a3 as Checkbox, L as Loading, Y as Card, a4 as Empty, W as DialogPlugin } from './tdesign-CfL1pweZ.js';
import { l as loadMammoth, a as adaptationFlowBar } from './index-TdM9I4Wf.js';
import { p as projectStore } from './project-Cze3Ugcr.js';
import { u as useAdaptationNav } from './useAdaptationNav-C85S50-f.js';
import { i as imageListCacheStore } from './imageListCache-JdBY0wS2.js';
import './dayjs-CuToSpIM.js';
import './index-yBIIU3Xk.js';
import './modelSelect-C4MDdN3m.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function handleEnterProduction(scriptId) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createVNode(adaptationFlowBar, { variant: "script" }),
                  ...
                  default: withCtx(() => [
                    ...
                    createBaseVNode("div", {
                      ...
                      createVNode(_component_t_button, {
                        ...
                        theme: "primary",
                        variant: "outline",
                        onClick: ($event) => handleEnterProduction(item.id)
                      }, {
                        default: withCtx(() => [
                          createTextVNode(toDisplayString(_ctx.$t("workbench.script.enterProduction")), 1)
                        ]),
                        _: 1
                      }, 8, ["onClick"])
                    ])
        ...
        createVNode(editScript, {
          ...
          "onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => isRef(detailsShow) ? detailsShow.value = $event : null),
        ...
        createVNode(addScript, {
          ...
          "onUpdate:modelValue": _cache[6] || (_cache[6] = ($event) => isRef(addScriptShow) ? addScriptShow.value = $event : null),
          onSearchScripts: searchScripts
        }, null, 8, ["modelValue"]),
        createVNode(batchAddScript, {
          modelValue: unref(batchScriptShow),
          "onUpdate:modelValue": _cache[7] || (_cache[7] = ($event) => isRef(batchScriptShow) ? batchScriptShow.value = $event : null),
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-22b6ed5c"]]);
