...
import { _ as __unplugin_components_0 } from './imageTools-5rRs3zXj.js';
import { o as openAssetsSelector } from './assetsCheck-C_EAKhUb.js';
import { a8 as Image, w as Dropdown, B as Button, a5 as Popup, n as Tooltip, A as Alert, K as Select, O as Option, E as Dialog, R as Input, I as Icon, Z as Table, G as ImageViewer, W as DialogPlugin } from './tdesign-CfL1pweZ.js';
...
import { _ as __unplugin_components_0$1 } from './modelSelect-C4MDdN3m.js';
import { p as promptEditor } from './promptEditor-Cb3f-aQB.js';
...
import { u as useLayout } from './index-VjQmDwQW.js';
...
const _hoisted_14 = { class: "operate ac jb" };
const _hoisted_15 = { class: "ac" };
const _hoisted_16 = {
  class: "f",
    ...
    async function handleGenerate(overridePrompt) {
      ...
      try {
        ...
        const { data } = await instance.post("/production/editImage/generateFlowImage", {
          ...
          prompt: overridePrompt ?? props.data.prompt,
          projectId: props.projectId,
          storyboardId: sid
        });
        props.data.generatedImage = data.url ?? data;
        if (data.feedback) lastFeedback.value = data.feedback;
      } catch (e) {
        const fb = e?.response?.data?.data?.feedback ?? e?.data?.feedback;
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$3, [
        ...
        withDirectives(createBaseVNode("div", {
          ...
          unref(lastFeedback)?.suggestedPrompt ? (openBlock(), createElementBlock("div", _hoisted_13, [
...
const generatedNode = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-bdba908c"]]);
...
const editImage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a5be21fc"]]);
