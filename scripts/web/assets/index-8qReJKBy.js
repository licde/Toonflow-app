const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./index-MckrY3Jk.js","./markdown-CDQfeHxT.js","./vue-vendor-Byo5TD6r.js","./dayjs-CuToSpIM.js","./index-DkAIKrBP.js","./tdesign-CfL1pweZ.js","./i18n-C05S5xzz.js"])))=>i.map(i=>d[i]);
...
import { s as settingStore, l as languageList, c as cachedLocale, _ as _export_sfc } from './index-DkAIKrBP.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "index",
  setup(__props) {
    const setting = defineAsyncComponent(() => __vitePreload(() => import('./index-MckrY3Jk.js'),true?__vite__mapDeps([0,1,2,3,4,5,6]):void 0,import.meta.url));
