const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./uiConfig-RxfUlhIN.js","./index-Iu-bOXAU.js","./markdown-CDQfeHxT.js","./vue-vendor-Byo5TD6r.js","./dayjs-CuToSpIM.js","./tdesign-CfL1pweZ.js","./i18n-C05S5xzz.js","./languageConfig-bGB7HyCl.js","./requestConfig-CddFxvte.js","./loginConfig-CbYJbH_S.js","./axios-mQi6SvTz.js","./agentConfog-CiaVu0A7.js","./modelSelect-tooHnLA2.js","./providersLogo-BCbaFq8_.js","./dbConfig-DyiKqX41.js","./otherConfig-CzuhfpP9.js","./about-BbUMbrIa.js","./index-d5Ic_5Wj.js","./project-Cze3Ugcr.js","./logoutConfig-CB_NABGL.js","./vendorConfig-6WDMFLWG.js","./AsyncMdPreview-DiyLF9bR.js","./AsyncMonacoEditor-DjKHAp69.js","./memoryConfig-B1pQQ8Ln.js","./fileManagement-BwIEUA7t.js","./skillManagement-Cjds_KoQ.js","./AsyncMdEditor-BGDSbuEn.js","./devConfig-BugoBQLp.js","./promptManage-BV3BHTTQ.js","./modelMap-DM_acblO.js"])))=>i.map(i=>d[i]);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const uiConfig = defineAsyncComponent(() => __vitePreload(() => import('./uiConfig-RxfUlhIN.js'),true?__vite__mapDeps([0,1,2,3,4,5,6]):void 0,import.meta.url));
    const languageConfig = defineAsyncComponent(() => __vitePreload(() => import('./languageConfig-bGB7HyCl.js'),true?__vite__mapDeps([7,6,3,4,1,2,5]):void 0,import.meta.url));
    const requestConfig = defineAsyncComponent(() => __vitePreload(() => import('./requestConfig-CddFxvte.js'),true?__vite__mapDeps([8,1,2,3,4,5,6]):void 0,import.meta.url));
    const loginConfig = defineAsyncComponent(() => __vitePreload(() => import('./loginConfig-CbYJbH_S.js'),true?__vite__mapDeps([9,10,1,2,3,4,5,6]):void 0,import.meta.url));
    const agentConfog = defineAsyncComponent(() => __vitePreload(() => import('./agentConfog-CiaVu0A7.js'),true?__vite__mapDeps([11,12,3,4,13,1,2,5,6,10]):void 0,import.meta.url));
    const dbConfig = defineAsyncComponent(() => __vitePreload(() => import('./dbConfig-DyiKqX41.js'),true?__vite__mapDeps([14,10,1,2,3,4,5,6]):void 0,import.meta.url));
    const otherConfig = defineAsyncComponent(() => __vitePreload(() => import('./otherConfig-CzuhfpP9.js'),true?__vite__mapDeps([15,1,2,3,4,5,6]):void 0,import.meta.url));
    const about = defineAsyncComponent(() => __vitePreload(() => import('./about-BbUMbrIa.js'),true?__vite__mapDeps([16,17,2,3,4,10,1,5,6,18]):void 0,import.meta.url));
    const logoutConfig = defineAsyncComponent(() => __vitePreload(() => import('./logoutConfig-CB_NABGL.js'),true?__vite__mapDeps([19,3,4,5,1,2,6]):void 0,import.meta.url));
    const vendorConfig = defineAsyncComponent(() => __vitePreload(() => import('./vendorConfig-6WDMFLWG.js'),true?__vite__mapDeps([20,3,4,21,2,5,1,6,22,10,13]):void 0,import.meta.url));
    const memoryConfig = defineAsyncComponent(() => __vitePreload(() => import('./memoryConfig-B1pQQ8Ln.js'),true?__vite__mapDeps([23,10,1,2,3,4,5,6]):void 0,import.meta.url));
    const fileManagement = defineAsyncComponent(() => __vitePreload(() => import('./fileManagement-BwIEUA7t.js'),true?__vite__mapDeps([24,1,2,3,4,5,6,10]):void 0,import.meta.url));
    const skillManagement = defineAsyncComponent(() => __vitePreload(() => import('./skillManagement-Cjds_KoQ.js'),true?__vite__mapDeps([25,26,2,3,4,5,1,6,21,10]):void 0,import.meta.url));
    const devConfig = defineAsyncComponent(() => __vitePreload(() => import('./devConfig-BugoBQLp.js'),true?__vite__mapDeps([27,22,2,3,4,5,1,6,10]):void 0,import.meta.url));
    const promptManage = defineAsyncComponent(() => __vitePreload(() => import('./promptManage-BV3BHTTQ.js'),true?__vite__mapDeps([28,10,1,2,3,4,5,6,26]):void 0,import.meta.url));
    const modelMap = defineAsyncComponent(() => __vitePreload(() => import('./modelMap-DM_acblO.js'),true?__vite__mapDeps([29,10,1,2,3,4,5,6,26]):void 0,import.meta.url));
    const menuItems = [
