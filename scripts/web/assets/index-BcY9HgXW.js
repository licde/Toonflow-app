...
import { d as dryRunImport, i as importHeal, b as importScriptBundle } from './ruleEngine-Dvli1DFa.js';
...
const _hoisted_25 = { class: "rule-panel__section-header" };
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  emits: ["copyChat", "copyAllChat", "rePush"],
    ...
    return (_ctx, _cache) => {
      return __props.loading ? (openBlock(), createElementBlock("div", _hoisted_1$1, "闭环检测中…")) : !__props.result ? (openBlock(), createElementBlock("div", _hoisted_2$1, "暂无闭环数据")) : (openBlock(), createElementBlock("div", _hoisted_3$1, [
        ...
        salvageSummary.value || __props.serverFixedIds?.length || __props.healLog?.length ? (openBlock(), createElementBlock("section", _hoisted_10$1, [
          _cache[0] || (_cache[0] = createBaseVNode("h4", null, "已自动完善（可展开追溯）", -1)),
        ...
        __props.result.closureReport?.missing?.length ? (openBlock(), createElementBlock("section", _hoisted_14, [
          _cache[1] || (_cache[1] = createBaseVNode("h4", null, "缺失项", -1)),
          createBaseVNode("ul", null, [
        ...
        __props.result.chatPromptGaps?.length ? (openBlock(), createElementBlock("section", _hoisted_15, [
          _cache[2] || (_cache[2] = createBaseVNode("h4", null, "Chat 提示词", -1)),
          createBaseVNode("ul", null, [
        ...
        __props.result.modalityGaps?.length ? (openBlock(), createElementBlock("section", _hoisted_16, [
          _cache[3] || (_cache[3] = createBaseVNode("h4", null, "模态链", -1)),
          createBaseVNode("ul", null, [
        ...
        __props.result.qualityGate?.issues?.length ? (openBlock(), createElementBlock("section", _hoisted_17, [
          _cache[4] || (_cache[4] = createBaseVNode("h4", null, "统一质量闸", -1)),
          createBaseVNode("ul", null, [
        ...
        __props.result.warnings?.length ? (openBlock(), createElementBlock("section", _hoisted_18, [
          _cache[5] || (_cache[5] = createBaseVNode("h4", null, "提示", -1)),
          createBaseVNode("ul", null, [
        ...
        serverFixedHints.value.length ? (openBlock(), createElementBlock("section", _hoisted_23, [
          _cache[6] || (_cache[6] = createBaseVNode("h4", null, "已服务端修复（无需再复制）", -1)),
        ...
        chatMustHints.value.length || isBlocked.value && allChatText.value.trim() ? (openBlock(), createElementBlock("section", _hoisted_24, [
          createBaseVNode("div", _hoisted_25, [
            _cache[7] || (_cache[7] = createBaseVNode("h4", null, "需 Chat 修改", -1)),
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList(chatMustHints.value, (h) => {
            return openBlock(), createElementBlock("div", {
              ...
              }, "复制到 Chat", 8, _hoisted_26)
            ]);
          }), 128))
        ])) : createCommentVNode("", true),
        __props.result.rePushPlan?.length ? (openBlock(), createElementBlock("section", _hoisted_27, [
          _cache[8] || (_cache[8] = createBaseVNode("h4", null, "回推计划", -1)),
          (openBlock(true), createElementBlock(Fragment, null, renderList(__props.result.rePushPlan, (p, i) => {
            return openBlock(), createElementBlock("div", {
              key: i,
              class: "rule-panel__repush"
            }, [
              createBaseVNode("span", null, toDisplayString(p.trigger || p.reason) + " → " + toDisplayString(p.reverseTarget), 1),
              p.presentationFork ? (openBlock(), createElementBlock("span", _hoisted_28, toDisplayString(forkLabel(p.presentationFork)), 1)) : createCommentVNode("", true),
              createBaseVNode("button", {
                type: "button",
                onClick: ($event) => emit("rePush", p)
              }, "回推 " + toDisplayString(p.reverseTarget) + "（仅跳转，未改数据）", 9, _hoisted_29)
            ]);
          }), 128))
        ])) : createCommentVNode("", true)
      ]));
...
const ClosureRulePanel = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-ca4e5c80"]]);
        ...
        default: withCtx(() => [
          createBaseVNode("div", _hoisted_1, [
            ...
            closurePreview.value ? (openBlock(), createBlock(ClosureRulePanel, {
              ...
              onCopyChat,
              onCopyAllChat
            }, null, 8, ["result", "shape-salvage-log", "server-fixed-ids", "chat-must-fix-ids", "export-allowed", "chat-repair-text", "user-message", "cta-label", "primary-next-step", "heal-log"])) : createCommentVNode("", true)
          ])
        ]),
        _: 1
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6c5ba51d"]]);
