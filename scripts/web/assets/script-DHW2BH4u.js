import { l as defineComponent, bM as storeToRefs, bU as useModel, aK as openBlock, aL as createElementBlock, j as createVNode, aM as withCtx, aO as createBaseVNode, b0 as toDisplayString, a$ as createTextVNode, a1 as unref, bH as withModifiers, F as Fragment, bV as mergeModels, r as ref } from './vue-vendor-Byo5TD6r.js';
import { c as _sfc_main$f, P as Position } from './vueflow-RSWomYB5.js';
import { A as AsyncMdEditor } from './AsyncMdEditor-BGDSbuEn.js';
...
import { b as useProductionAgentStore } from './useAdaptationNav-CN9vydeI.js';
import { B as Button, Y as Card, E as Dialog } from './tdesign-CfL1pweZ.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const props = __props;
    const script = useModel(__props, "modelValue");
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        createVNode(_component_t_card, { class: "script" }, {
          default: withCtx(() => [
            createBaseVNode("div", _hoisted_1, [
              createBaseVNode("div", _hoisted_2, toDisplayString(_ctx.$t("workbench.production.node.script.title")), 1),
            ...
            createBaseVNode("div", _hoisted_3, [
              createVNode(AsyncMdPreview, {
                ...
                "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => script.value = $event),
                theme: unref(themeSetting).mode
              }, null, 8, ["modelValue", "theme"])
            ]),
            createVNode(unref(_sfc_main$f), {
              id: props.handleIds.assets,
              type: "source",
        ...
        createVNode(_component_t_dialog, {
          ...
          header: _ctx.$t("workbench.production.node.script.editDialog"),
          width: "90vw",
...
const script = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-52897e85"]]);
