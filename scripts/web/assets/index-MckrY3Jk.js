const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./uiConfig-BJ62xvsb.js","./index-DkAIKrBP.js","./markdown-CDQfeHxT.js","./vue-vendor-Byo5TD6r.js","./dayjs-CuToSpIM.js","./tdesign-CfL1pweZ.js","./i18n-C05S5xzz.js","./languageConfig-IjRUFdyi.js","./requestConfig-DCVk1ZIj.js","./loginConfig-CWvxhxSG.js","./axios-BX4BN6mO.js","./agentConfog--fdkmps1.js","./modelSelect-CIGhMzmI.js","./providersLogo-BCbaFq8_.js","./dbConfig-CqvMjTvN.js","./otherConfig-DHUYTlvo.js","./about-Ben7YI4V.js","./index-8qReJKBy.js","./project-Cze3Ugcr.js","./logoutConfig-Cx7VZf-u.js","./vendorConfig-1almWXaq.js","./AsyncMdPreview-D9IGMFOZ.js","./AsyncMonacoEditor-dtyhjFm6.js","./memoryConfig-BgfpDCWx.js","./fileManagement-DLuuG2s4.js","./skillManagement-BeNxnj7d.js","./AsyncMdEditor-CJVlVNjS.js","./devConfig-DmH9dnpi.js","./promptManage-DPAibUBW.js","./modelMap-CWGJmVS4.js"])))=>i.map(i=>d[i]);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const uiConfig = defineAsyncComponent(() => __vitePreload(() => import('./uiConfig-BJ62xvsb.js'),true?__vite__mapDeps([0,1,2,3,4,5,6]):void 0,import.meta.url));
    const languageConfig = defineAsyncComponent(() => __vitePreload(() => import('./languageConfig-IjRUFdyi.js'),true?__vite__mapDeps([7,6,3,4,1,2,5]):void 0,import.meta.url));
    const requestConfig = defineAsyncComponent(() => __vitePreload(() => import('./requestConfig-DCVk1ZIj.js'),true?__vite__mapDeps([8,1,2,3,4,5,6]):void 0,import.meta.url));
    const loginConfig = defineAsyncComponent(() => __vitePreload(() => import('./loginConfig-CWvxhxSG.js'),true?__vite__mapDeps([9,10,1,2,3,4,5,6]):void 0,import.meta.url));
    const agentConfog = defineAsyncComponent(() => __vitePreload(() => import('./agentConfog--fdkmps1.js'),true?__vite__mapDeps([11,12,3,4,13,1,2,5,6,10]):void 0,import.meta.url));
    const dbConfig = defineAsyncComponent(() => __vitePreload(() => import('./dbConfig-CqvMjTvN.js'),true?__vite__mapDeps([14,10,1,2,3,4,5,6]):void 0,import.meta.url));
    const otherConfig = defineAsyncComponent(() => __vitePreload(() => import('./otherConfig-DHUYTlvo.js'),true?__vite__mapDeps([15,1,2,3,4,5,6]):void 0,import.meta.url));
    const about = defineAsyncComponent(() => __vitePreload(() => import('./about-Ben7YI4V.js'),true?__vite__mapDeps([16,17,2,3,4,10,1,5,6,18]):void 0,import.meta.url));
    const logoutConfig = defineAsyncComponent(() => __vitePreload(() => import('./logoutConfig-Cx7VZf-u.js'),true?__vite__mapDeps([19,3,4,5,1,2,6]):void 0,import.meta.url));
    const vendorConfig = defineAsyncComponent(() => __vitePreload(() => import('./vendorConfig-1almWXaq.js'),true?__vite__mapDeps([20,3,4,21,2,5,1,6,22,10,13]):void 0,import.meta.url));
    const memoryConfig = defineAsyncComponent(() => __vitePreload(() => import('./memoryConfig-BgfpDCWx.js'),true?__vite__mapDeps([23,10,1,2,3,4,5,6]):void 0,import.meta.url));
    const fileManagement = defineAsyncComponent(() => __vitePreload(() => import('./fileManagement-DLuuG2s4.js'),true?__vite__mapDeps([24,1,2,3,4,5,6,10]):void 0,import.meta.url));
    const skillManagement = defineAsyncComponent(() => __vitePreload(() => import('./skillManagement-BeNxnj7d.js'),true?__vite__mapDeps([25,26,2,3,4,5,1,6,21,10]):void 0,import.meta.url));
    const devConfig = defineAsyncComponent(() => __vitePreload(() => import('./devConfig-DmH9dnpi.js'),true?__vite__mapDeps([27,22,2,3,4,5,1,6,10]):void 0,import.meta.url));
    const promptManage = defineAsyncComponent(() => __vitePreload(() => import('./promptManage-DPAibUBW.js'),true?__vite__mapDeps([28,10,1,2,3,4,5,6,26]):void 0,import.meta.url));
    const modelMap = defineAsyncComponent(() => __vitePreload(() => import('./modelMap-CWGJmVS4.js'),true?__vite__mapDeps([29,10,1,2,3,4,5,6,26]):void 0,import.meta.url));
    const menuItems = [
