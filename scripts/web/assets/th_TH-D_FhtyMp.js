...
const settings = {
	...
	agent: {
		bannerDesc: "ขอแนะนำให้ใช้ DeepSeek V4 อย่างเป็นทางการ",
...
const generate = "สร้างวิดีโอ";
const history = "เวอร์ชันประวัติศาสตร์";
const generating = "กำลังสร้าง";
const generateFailed = "ล้มเหลว";
const selectAll = "เลือกทั้งหมด";
const selected = "เลือกแล้ว";
const importVideo = "นำเข้าวิดีโอ";
const emptyTrack = "ย่อหน้า {index}";
const del = "ยืนยันการลบ";
const delConfirm = "คุณแน่ใจหรือไม่ว่าต้องการลบย่อหน้านี้";
const selectSource = "เลือกแหล่งที่มา";
const confirm = "เลือกจากสินทรัพย์";
const cancel = "เลือกจากกระดานเรื่องราว";
const version = {
...
const th_TH = {
	...
	"storyboard.assets.addStoryboardFailed": "ไม่สามารถเพิ่มสตอรี่บอร์ดได้"
};

export { cancel, components, confirm, th_TH as default, del, delConfirm, emptyTrack, generate, generateFailed, generating, hello, history, importVideo, login, productionAgent, promptManage, selectAll, selectSource, selected, setting, settings, skillScan, storyboard, version, workbench };
