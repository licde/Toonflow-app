...
const settings = {
	...
	agent: {
		bannerDesc: "Рекомендуется использовать официальную версию DeepSeek V4.",
...
const generate = "Создать видео";
const history = "Историческая версия";
const generating = "Создание";
const generateFailed = "неудача";
const selectAll = "Выбрать все";
const selected = "Выбрано";
const importVideo = "Импортировать видео";
const emptyTrack = "Абзац {index}";
const del = "Подтвердить удаление";
const delConfirm = "Вы уверены, что хотите удалить этот абзац?";
const selectSource = "Выберите источник";
const confirm = "Выбрать из активов";
const cancel = "Выбрать из раскадровки";
const version = {
...
const ru_RU = {
	...
	"storyboard.assets.addStoryboardFailed": "Не удалось добавить раскадровку."
};

export { cancel, common, components, confirm, ru_RU as default, del, delConfirm, emptyTrack, generate, generateFailed, generating, hello, history, importVideo, login, productionAgent, promptManage, selectAll, selectSource, selected, setting, settings, skillScan, storyboard, version, workbench };
