    ...
    try {
      ...
      return res.status(200).send(
        success({
          ...
          vendorPromptUsed: (result as { vendorPromptUsed?: string }).vendorPromptUsed ?? result.promptUsed,
          canvasDisplayPrompt: (result as { canvasDisplayPrompt?: string }).canvasDisplayPrompt,
          refThumbUrls: (result as { refThumbUrls?: string[] }).refThumbUrls,
          oneClickRepairKind: (result as { oneClickRepairKind?: string | null }).oneClickRepairKind ?? null,
